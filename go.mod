...
require (
	...
	charm.land/bubbletea/v2 v2.0.0-rc.2.0.20260209074636-30878e43d7b0 // indirect
	charm.land/catwalk v0.19.2 // indirect
	charm.land/fantasy v0.8.1 // indirect
	...
	github.com/charmbracelet/x/powernap v0.0.0-20260209132835-6b065b8ba62c // indirect
